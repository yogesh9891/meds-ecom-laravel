...
<body>
	...
	<div>
		...
		<table width='600px' border='0' cellspacing='0' cellpadding='0' bgcolor='#3f3fdd' style='font-family:Arial, Helvetica, sans-serif; font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(254, 225, 232,1) 100%)'><tr> <td style='padding:10px;'> 
...
<td style="padding:10px;"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="white" style="border-radius:8px;" style="border-radius:8px;">
...
<td style="color:black;font-size:13px;padding:5px 5px 5px 10px;">We thank you for making a Credit Card payment of <span style="color: #3f3fdd">USD {{round($summary->c_14_96_forex_received)}}</span></strong>- for your <a href="{{route('order.invoice',$summary->c_14_7_order_invoice_url)}}" target="_blank" ><b>Order No. </b>{{$summary->c_14_2_online_invoice_no}}</a> dated  {{$summary->created_at->timezone('Asia/Kolkata')->format('d M, Y')}} for :<br aria-hidden="true">
...
<td style="color:white;font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(254, 225, 232,1) 100%);">
