...
<body>
  ...
  <div>
    ...
    <table width='600px' border='0' cellspacing='0' cellpadding='0' bgcolor='#3f3fdd' style='font-family:Arial, Helvetica, sans-serif; font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(143, 202, 202,1) 100%)'><tr> <td style='padding:10px;'> 
...
has been <a href="{{ $summary->c_14_118_tracking_url }}" target="_blank"> Customs Cleared </a> in {{ $summary->c_14_29_receiver_country }} . <br aria-hidden="true">
...
<td style="padding:0px 10px;">
  ...
  <p><strong>The parcel should be delivered to you in the next few days.</strong></p>

  <p><strong>Please acknowledge on receipt of the same.</strong></p>
...
<td style="color:white;font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(143, 202, 202,1) 100%);">
