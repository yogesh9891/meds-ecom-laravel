...
<td style="color:black;font-size:13px;padding:5px 5px 5px 10px;">This is a Refill Reminder for your <a href="{{route('order.invoice',$summary->c_14_7_order_invoice_url)}}" target="_blank" ><b>Order No. </b>{{$summary->c_14_2_online_invoice_no}}</a> dated  {{$summary->created_at->timezone('Asia/Kolkata')->format('d M, Y')}} for :<br aria-hidden="true">
...
<a href="{{$summary->c_14_118_tracking_url}}" target="_blank" >successfully delivered</a> to you in {{ $summary->c_14_29_receiver_country }} . <br aria-hidden="true">
...
<td style="padding:0px 10px;">
  ...
  <p><strong>You had requested a Refill Reminder after {{ $summary->c_14_85_refil_after_days }} days and so,</strong><br>

 do inform if any changes are required in the previous order and we will get a repeat order created for you.</p>
