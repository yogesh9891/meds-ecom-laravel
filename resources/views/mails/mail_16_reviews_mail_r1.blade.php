...
<body>
  ...
  <div>
    ...
    <table width='600px' border='0' cellspacing='0' cellpadding='0' bgcolor='#3f3fdd' style='font-family:Arial, Helvetica, sans-serif; font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(255, 197, 191,1) 100%)'><tr> <td style='padding:10px;'> 
...
<td style="color:black;font-size:13px;padding:5px 5px 5px 10px;">As per the latest update from DHL, we are pleased to know that your medicines have been <a href="{{ $summary->c_14_118_tracking_url }}" target="_blank">  delivered </a> in  {{ $summary->c_14_29_receiver_country }}. <br aria-hidden="true">
...
<td style="padding:0px 10px;">
  ...
  <p>We are a family-owned business trying our best to help people worldwide with affordable medicines.</p>

  <p>As such, we request you to <strong> please give us an honest review on your buying experience with us by log-in at the following link:</strong><br>

<a href="https://www.trustpilot.com/evaluate/911GlobalMeds.com">  https://www.trustpilot.com/evaluate/911GlobalMeds.com</a> </p>
...
<p>Your review will be helpful to many patients worldwide.</p>

<p>

We would like to thank you in advance for the same. 
...
<td style="color:white;font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(255, 197, 191,1) 100%);">
