...
<body>
	...
	<div>
		...
		<table width='600px' border='0' cellspacing='0' cellpadding='0' bgcolor='#3f3fdd' style='font-family:Arial, Helvetica, sans-serif; font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(203, 170, 203,1) 100%)'><tr> <td style='padding:10px;'> 
...
<td style="color:black;font-size:13px;padding:5px 5px 0px 10px;"><b>      
        ...
        <p>You added an item to your  <strong> <a  target="_blank"  href="{{ route('cart.order',$summary->c_14_4_cart_url) }}" target="_blank"> Shopping Cart </a></strong> and haven't completed your order.

          You can complete it now while it is still available :</p>
...
If you are facing any issue preventing your order completion then do contact us back and we will be happy to assist you.  <br><br  aria-hidden="true">
...
<td style="color:white;font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(203, 170, 203,1) 100%);">
