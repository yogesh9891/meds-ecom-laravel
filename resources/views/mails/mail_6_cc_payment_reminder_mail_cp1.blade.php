...
<body>
	...
	<div>
		...
		<table width='600px' border='0' cellspacing='0' cellpadding='0' bgcolor='#3f3fdd' style='font-family:Arial, Helvetica, sans-serif; font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(255, 204, 182,1) 100%)'><tr> <td style='padding:10px;'> 
...
<td style="padding:0px 10px;">
            ...
            <p>Your preference was to <strong>pay via Credit Card, </strong> and as such, you can pay <strong><span style="color: #3f3fdd">USD {{round($summary->c_14_84_total_amount)}}</span></strong>- by clicking on the Credit Card payment link below:</p>
             ...
             <p><strong>and so <span class="red-text" style="color: red;">please fill ONLY YOUR CREDIT CARD DETAILS <font color="black"> and </font> NOTHING ELSE</span> in the above payment link.</strong></p>
...
<td style="color:white;font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(255, 204, 182,1) 100%);">
