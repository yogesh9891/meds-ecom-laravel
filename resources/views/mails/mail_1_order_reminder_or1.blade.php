...
<body>
	...
	<div>
		...
		<table width='600px' border='0' cellspacing='0' cellpadding='0' bgcolor='#3f3fdd' style='font-family:Arial, Helvetica, sans-serif;border-radius: 8px; font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(171, 222, 230,1) 100%)'><tr> <td style='padding:10px;'> 
...
<td style="color:black;font-size:13px;padding:5px 5px 5px 10px;">We welcome your requirement for :<br aria-hidden="true">



<table style="font-size:13px;font-family:Arial,Helvetica,sans-serif;border:1px solid black;border-radius: 8px;" width="100%" cellspacing="0" cellpadding="3" border="1">
...
<p>Your  <strong> <a  target="_blank"  href="{{ route('cart.order',$summary->c_14_4_cart_url) }}" target="_blank">Order Cart-Checkout</a></strong> does not show all the required Billing and Delivery address etc. details.<br aria-hidden="true"></p>

<p>Please fill the same at your  <strong> <a  target="_blank"  href="{{ route('cart.order',$summary->c_14_4_cart_url) }}" target="_blank">Cart page link</a></strong> to complete your Order process.<br aria-hidden="true"></p>

We look forward to serve your medication requirements by our very best.<br>
...
<td style="color:white;font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(171, 222, 230,1) 100%);">
