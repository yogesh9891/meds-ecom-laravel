...
<body>
  ...
  <div>
    ...
    <table width='600px' border='0' cellspacing='0' cellpadding='0' bgcolor='#3f3fdd' style='font-family:Arial, Helvetica, sans-serif; font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(255, 219, 204,1) 100%)'><tr> <td style='padding:10px;'> 
...
has <a href="{{ $summary->c_14_118_tracking_url }}" target="_blank"> arrived at the Customs Office</a> in {{ $summary->c_14_29_receiver_country }} . <br aria-hidden="true">
...
<td style="padding:0px 10px;">
  ...
  <p><strong>We will keep you informed on the further parcel clearance status at {{ $summary->c_14_29_receiver_country }}  Customs.</strong></p>
...
<td style="color:white;font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(255, 219, 204,1) 100%);">
