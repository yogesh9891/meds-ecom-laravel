...
<body>
  ...
  <div>
    ...
    <table width='600px' border='0' cellspacing='0' cellpadding='0' bgcolor='#3f3fdd' style='font-family:Arial, Helvetica, sans-serif; font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(252, 217, 170,1) 100%)'><tr> <td style='padding:10px;'> 
...
<td style="color:black;font-size:13px;padding:5px 5px 5px 10px;">We have made the shipment of you <a href="{{route('order.invoice',$summary->c_14_7_order_invoice_url)}}" target="_blank" ><b>Order No. </b>{{$summary->c_14_2_online_invoice_no}}</a> dated  {{ date_format(date_create($summary->c_14_115_parcel_shipment_date),"d M, Y") }} for :<br aria-hidden="true">
...
<td style="padding:0px 10px;">
            ...
            <p> <strong>The parcel has been shipped by DHL courier with Tracking no. <a href="{{ $summary->c_14_118_tracking_url }}" target="_blank">{{ $summary->c_14_117_tracking_no }}</a></strong></p>
...
<td style="padding:0px 10px;">
  ...
  <p>We will keep you informed on the further parcel movement status at the mentioned courier company.</p>
...
<td style="color:white;font-size:13px;border-radius:8px;border-radius:8px;background: linear-gradient(90deg, rgba(138, 136, 136,1) 0%, rgb(252, 217, 170,1) 100%);">
