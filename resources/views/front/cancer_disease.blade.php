...
<title>{{ $medsSeo->c_3_6_3_meta_title ??''}}</title>
   ...
   <!-- META TAGS -->
	...
	<link rel="canonical" href="{{route('canceer_disease_medication')}}"/>
    ...
    {"@context":"http:\/\/schema.org","@type":"Pharmacy","name":"Most Common Oral Chemo Therapy Cancer Drugs Names & Price List","description":"911GlobalMeds.com is the best online pharmacy to buy Prescription Drugs Online at the lowest price. Visit at 911 Global meds site to find the Most Common types of Oral Chemo-therapy Cancer Drugs with names &amp; price List.","openingHours":"Mo,Tu,We,Th,Fr,Sa 00:00-24:00","email":"WeCare@911GlobalMeds.com","telephone":"1-567-252-7545","image":"https://www.911globalmeds.com/img/911-Global-Meds-logo.webp","url":"https://www.911globalmeds.com/most-common-oral-chemo-therapy-cancer-drugs-names-and-price-list","priceRange":"$$","address":{"@type":"PostalAddress","addressLocality":"Toronto","addressRegion":"Ontario","addressCountry":"CA","postalCode":"M2N 6S3","streetAddress":"1145/9 Midland Avenue"}} "aggregateRating": {
        "@type": "AggregateRating","ratingValue": "{{ $medsSeo->c_3_6_14_rating_value??'93' }}","reviewCount": "{{ $medsSeo->c_3_6_15_rating_count??'686' }}"),
//]]></script>

@endsection

 <div class="bg_meds cancer_meds" id="bg_meds">
...
<div class="container mt-5">
	...
	<div class="row">
				  ...
				  <div>
					...
					<div class="accordion" id="faq">
                    	...
                    	<div class="card">
                    	    ...
                    	    <p classs="font20 blue-text-p dpnd" ><strong><a style="color:#2E3192" href="{{route('canceer_disease_medication')}}">Cancer Diseases Medications</a></strong></p>

	                        <div class="card-header" id="faqhead1">

	                            <h1 class="btn btn-header-link" data-toggle="collapse" data-target="#faq1"

	                            aria-expanded="true" aria-controls="faq1"><strong>Most Common Oral Chemo Therapy Cancer Drugs Names & Price List for :</strong></h1>
                        ...
                        <div id="faq1" class="collapse" aria-labelledby="faqhead1" data-parent="#faq">
                            ...
                            <div class="card-body">
                               ...
                               <div class="list_ofr nav nav-tabs"  role="tablist">
                               		...
                               		@foreach($general_diseases->sortBy('c_3_4_2_critical_disease') as $general_disease)

                               	<a class="nav-link btn-nav-link @if($loop->first) active @endif" href="#medcinie_{{str_slug($general_disease->c_3_4_2_critical_disease)}}"  id="medcinie_{{str_slug($general_disease->c_3_4_2_critical_disease)}}-tab" data-toggle="tab" data-target="#medcinie_{{str_slug($general_disease->c_3_4_2_critical_disease)}}"  role="tab" aria-controls="medcinie_{{str_slug($general_disease->c_3_4_2_critical_disease)}}" aria-selected="true">{{$general_disease->c_3_4_2_critical_disease}}</a>

                               		@endforeach

                                    	<a class="mt-2  nav-heading1"  aria-busy="true"  href="{{route('all_disease_medication')}}" target="_blank" ><strong>General Diseases Medications</strong></a>
       ...
       <div class="heading_mainsitemap tab-pane fade  @if($loop->first) active show @endif"  role="tabpanel" aria-labelledby="medcinie_{{str_slug($general_disease->c_3_4_2_critical_disease)}}-tab" id="medcinie_{{str_slug($general_disease->c_3_4_2_critical_disease)}}">
			<h2 class="mb-3 font20 blue-text dpnd"><a href="{{$general_disease->si_source_url??''}}" target="_blank"><strong>About <span >{{$general_disease->c_3_4_2_critical_disease}}</span> - Information & Treatment Drugs</strong></a></h2>

			@if($general_disease->crtical_medicines)

		

			@foreach($general_disease->crtical_medicines as $med_index=> $generic_medicine)
           ...
           <div  class="carousel slide" id="carouselExampleIndicators_{{$generic_medicine->id}}-{{$generic_medicine->generic_med_no}}"  data-ride="carousel"  data-interval="500">
...
@php  $count++; @endphp
                    ...
                    <div class="carousel-item  active">
                        <img class="img-fluid lazy " data-original="{{asset('img-me/default-icon-m.webp')}}" alt="tablet capsule injection medicine icon">

                      </div>
             			@else
             			@if($count > 1)
             			    <a class="carousel-control-prev" href="#carouselExampleIndicators-{{$med_index}}-{{$generic_medicine->generic_med_no}}" role="button" data-slide="prev">
             			    	.
                          <i class="fa fa-chevron-left" aria-hidden="true"></i>

                     </a>

                     <a class="carousel-control-next" href="#carouselExampleIndicators-{{$med_index}}-{{$generic_medicine->generic_med_no}}" role="button" data-slide="next">
     ...
     <!--              </p> -->
			...
			@endforeach
				...
				<div class="text-center " >
					...
					<a href="#" class="m-2 d-block go-to-top">Go to Top : Cancer Diseases Index</a>
				</div>
		</div>
					...
					<div class="atoztabbing" id="accordion">
						...
						<div class="atoztabbing-inner">
							...
							<div class="alpha-card" id="a-heading">
								...
								<a data-toggle="collapse" data-target="#genric{{ strtolower($key) }}-collapse"  >
					  ...
					  <div class="atoztabbing-content all-alphabetsContent">
						  ...
						  <div id="genric{{ strtolower($key) }}-collapse" class="collapse" aria-labelledby="{{ $key }}-heading" data-parent="#accordion">
					...
					<div class="atoztabbing" id="accordion-generic-drugs">
						...
						<div class="atoztabbing-inner">
							...
							<div class="alpha-card" id="a-heading">
								...
								<a data-toggle="collapse" data-target="#other{{ strtolower($key) }}-collapse"  >
					  ...
					  <div class="atoztabbing-content all-alphabetsContent">
						  ...
						  <div id="other{{ strtolower($key) }}-collapse" class="collapse" aria-labelledby="a-heading" data-parent="#accordion-generic-drugs">
