...
<title>911GlobalMeds.com : Order Invoice </title>
...
<div class="invoice-box">
				...
				<div class="row justify-content-md-center text-center font15 socialmediainvoice">
						...
						<div class="col-md-12"><div class="main-logos text-center"><div class="logo mb-2 ml-auto mr-auto"><a href="{{url('/')}}"><img src="{{asset('img/911-Global-Meds-logo.webp')}}" alt="get fda approved prescription drugs express medicine shipments online at global HK and Canada pharmacy marketplace co"></a></div></div></div>
				...
				<div class="row pt-3 pb-3 border-t mt-2 pb-2 pt-2">
					...
					<div class="col-md-6 "><p><strong>Order Invoice no.: </strong>  MYT-{{$summary->c_14_2_online_invoice_no}}</p></div>

					<div class="col-md-6 "><p><strong>Dated </strong>  {{$summary->created_at->format('d M Y')}}</p></div>

				</div>

			@if($summary->is_order == 1)
	...
	<p style="margin-top: 0;line-height:1.5;">
				...
				<div class="row pt-3 pb-2 border-t">
				  ...
				  <table width="100%" cellspacing="0" border="0" cellpadding="0" class="table table-borderless">
                    ...
                    @endif
                    	...
                    	@if($summary->c_14_76_promo_discount)
						...
						@if($summary->c_14_78_additional_charges > 0)

						<tr class="detailsnoborder">

							<td colspan="3" align="right" class="text-right">Any Additional Charges (+)</td>

							<td align="right" style="vertical-align: top;padding-right:30px;"><strong>$ {{round($summary->c_14_78_additional_charges)}}</strong></td>
						...
						<tr class="detailsnoborder">
							...
							<td align="right" style="vertical-align: top;padding-right:30px;"><strong>$ {{round($summary->c_14_81_pod_charges)}}</strong></td>
						...
						@if($summary->c_14_82_credit_card_processing_fees)

						<tr class="detailsnoborder">

							<td colspan="3" align="right" class="text-right">Credit Card Processing Fees (+)</td>

							<td align="right" style="vertical-align: top;padding-right:30px;"><strong>$ {{round($summary->c_14_82_credit_card_processing_fees)}} </strong></td>
						...
						<tr>
						  ...
						  <td align="right" style="color:#00a2ed;padding-top:15px;padding-bottom:15px;padding-right:30px;"><strong>US$ {{round($summary->c_14_84_total_amount)}}</strong></td>
				...
				<div class=" mt-3">
					...
					<div class="row pb-3 pt-3">
						...
						@if($summary->bank_company_code =='USD-HK-AW-BCHK')
							...
							<table width="100%" cellspacing="0" border="0" cellpadding="0">
									...
									<thead>
										...
										<tr>
											...
											<th align="left" scope="col" style="padding:5px 5px 5px 5px;border-top: solid 1px #000;border-right: solid 1px #000;border-bottom: solid 1px #000;border-left: solid 0px #000;width:75%;font-weight:normal;">{{$summary->bank_account_name  ?? ''}}</br><span class="astrik">Mention EXACTLY and in FULL as above</span></th>
				...
				<div class=" mt-4 mb-4">
					...
					<div class="col-md-12">
							...
							<p>As you wish to <strong>pay via Credit Card</strong>, you can pay <strong><span class="red-text">USD {{round($summary->c_14_84_total_amount)}}</span></strong>- by clicking on the Credit Card payment link below:</p>

							<p class="mb-5"><a class="wordbreak fw-600 text-underline blue-text" target="_blank"  href="{{ $summary->c_14_92_cc_request_link }}" target="_blank">{{ $summary->c_14_92_cc_request_link }}</a></p>

							<p><strong>NOTE : You need to <b class="red-text"> FILL ONLY YOUR CREDIT CARD DETAILS</b> as all Order related reference details have been filled by us in the Credit Card Payment Request, details as :</strong></p>

							<p class="blue-text fw-600">{{$summary->c_14_86_cc_name}} : Pay for Order no. {{ $summary->c_14_2_online_invoice_no }}</p>

							<br>

							<p><b class="red-text">DO NOT MENTION ANY 'Drugs Or Medicines' etc words</b> while making the payment as our bank may charge you extra commission to process a 'Medication' purpose payment.</p>
				...
				@else
					...
					<div class="my-5  text-center">
						...
						is ready to ship the same by FedEx / DHL / UPS / USPS / EMS. </h4> 
     					 ...
     					 <h4 class="text-center my-3"> Please see the final <strong><a href="{{route('order.invoice',$summary->c_14_4_cart_url??'url')}}" >ORDER INVOICE</a> </strong>& proceed with the payment.</h4>
                    ...
                    <form class="mt-0" method="post" id="queryForm" >
                        ...
                        <div class="fieldset">
							...
							<div class="text-danger" id="query-error"></div>
										<input type="hidden" name="url" value="{{'order-invoice/'.$summary->c_14_7_order_invoice_url }}" >
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="full_name" id="full_name1" class="form-control Cfield" placeholder="Full Name" required=""  onkeyup="nameValidation(this)">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <button type="submit"  class="btn nobtn green-bg lg-btn mt-2">Send Query</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<script type="text/javascript">
        ...
        let formData = new FormData(this);
               ...
               $.ajax({
                  ...
                  //     url     : "{{'order-invoice/'.$summary->c_14_7_order_invoice_url }}",
