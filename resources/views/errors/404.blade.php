   ...
   <div class="container">
      <div class="content-part mt-5">
         <div class="common-heading text-center mb-4">
            <h1 class="font30 fw-600 green-text text-uppercase">Page Not Found</h1>
         </div>
         <div class="inner-banner img_round">
            <a href="{{ url('/') }}"><img src="{{  asset('img/error-image.webp')}}" width="100%" alt=""></a>
         </div>
	...
	<div class="content-part categorypage brand-vs-generic mt-5">
		<div class="row text-center">
			...
			<div class="col-md-12">
						<h4>Find the Medicine You Want :
</h4>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6">

				<h1 class="font30 green-text"><strong> Generic Drugs & Generic Medications List: </strong></h1>
				...
				<div class="seelist-alphabet">
					...
					<div class="atoztabbing" id="accordion">
						...
						<div class="atoztabbing-inner">
							@php  $all_medcines =  all_drugs(); @endphp
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				...
				<h2 class="font30 green-text"><strong> Brand Drugs & Brand Medications List:</strong></h2>
						...
						<div class="alphalist">
							...
							<div class="seelist-alphabet">
								...
								<div class="atoztabbing" id="accordion-generic-drugs">
									...
									<div class="atoztabbing-inner">
							@php  $genric_medcines =  generic_drugs(); @endphp
		 ...
		 <div class="sitemapbox">
		 	...
		 	<h4>OR <br>
Open any Other Page of Your Choice :</h4>
</div>
					<div class="col-sm-3">                     
                     <ul class="links">
