								...
								<div class="col-md-6">
									<div class="form-group row">
										<label class="col-sm-2">Medicine</label>
											<div class="col-sm-10">
											<select placeholder="Select" class="form-control  form-check-inline">
											   <option value="1">911 – Medication</option>
											   <option value="2">Generic Name</option>
											   <option value="3">Generic Name</option>
											   <option value="4">Generic Name</option>
										...
										<thead class="text-center">
										  ...
										  <tbody>
											...
											<td><input type="checkbox" class="inputAuto" /></td>
											  ...
											  <td>28-02-22 <br>Medicine-108<br>3</td>
											  <td>Ron Diestro <br>  USA <br>Ron12598@gmail.com</td>
											  <td>Very good services</td>
											  <td>Medicine  Y  Y<br>Reviews  Y  Y<br>About Us  Y  Y<br>Home  Y  Y</td>
											  <td class="action">
