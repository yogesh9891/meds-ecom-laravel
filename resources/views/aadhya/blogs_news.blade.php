                    ...
                    <div class="panel-container">
									...
									<table id="datatable" class="table custom-table table-bordered">
										<thead class="text-center">
										  ...
										  <tbody>
											...
											<tr>
											  <td><input type="checkbox"  id="master" class="inputAuto" /></td>
											  <td>{{$blognew->id}}</td>
                        ...
                        <div class="main-section double-heading">
                            <div class="main-border ">
                                ...
                                <form action="{{route('aadhya.blog_news.store')}}" method="post" enctype="multipart/form-data"> 
                                @csrf   
								<div class="row">
                                <div class="col-md-3 col-sm-12">
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" name="blogNewsNo"  class="form-control"> 
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" name="blogTitleH1Tag"  class="form-control"> 
										</div>
									</div>
								</div>
                                <div class="col-md-12">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" name="pageUrlName"  class="form-control"> 
										</div>
									</div>
								</div>
                                <div class="col-md-12">
								...
								<div class="col-md-12">
									...
									<div class="col-sm-8">
									  <input type="text" name="" value="" class="form-control" id="image_url" placeholder="Image URL">					 
									</div>
								  </div>
								</div>
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="form-group row">
										...
										<div class="col-sm-12">
											<textarea id="editor1" name="briefIntroduction" ></textarea>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group row">
									  ...
									  <div class="col-sm-12">
											<textarea name="fullInformation" id="editor2"  ></textarea>
										</div>
									</div>
								</div>
						...
						<div class="main-section">
                                ...
                                <div class="main-border">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" rows="2"  name="canonical"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
									...
									<div class="inputBtn"><input type="submit" class="btn greenBtn" value="Save to Database" /></div>
                                </div>
                                </div>
