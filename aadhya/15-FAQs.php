                ...
                <div class="container-fluid">
                    <div class="panel-container">
						...
						<div class="main-section">							
							<div class="main-border">
								<div class="entry-title">
									<h2><span>FAQs for How to Order</span></h2>
								</div>
								<small class="mb-3 d-block">DBT: 15-1-FAQ-Ordering</small>
								<div class="row">
						...
						<div class="main-section">							
							<div class="main-border">
								<div class="entry-title">
									<h2><span>FAQs – General 1</span></h2>
								</div>
								<small class="mb-3 d-block">DBT: 15-2-FAQ-General-1</small>
						...
						<div class="main-section">							
							<div class="main-border">
								<div class="entry-title">
									<h2><span>FAQs – General 2</span></h2>
								</div>
								<small class="mb-3 d-block">DBT: 15-3-FAQ-General-2</small>
						...
						<div class="main-section">							
							<div class="main-border">
								<div class="entry-title">
									<h2><span>FAQs – General 3</span></h2>
								</div>
								<small class="mb-3 d-block">DBT: 15-4-FAQ-General-3</small>
						...
						<div class="main-section">							
							<div class="main-border">
								<div class="entry-title">
									<h2><span>FAQs – General 4</span></h2>
								</div>
								<small class="mb-3 d-block">DBT: 15-5-FAQ-General-4</small>
						...
						<div class="main-section">							
							<div class="main-border">
								...
								<small class="mb-3 d-block">DBT: 15-6-FAQ-B-vs-G</small>
								...
								<div class="row">
									...
									<div class="row mt-3">
										<div class="col-md-12">
											<div class="form-group row mb-0">
											<label class="col-md-2 col-sm-6 col-form-label">Answer</label>
											<div class="col-md-10 col-sm-6 bibtextarea"><textarea name="editor5" id="editor5"></textarea></div>
											</div>
										</div>
									</div>
